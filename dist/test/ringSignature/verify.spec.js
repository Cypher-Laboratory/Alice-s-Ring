...
describe("Test verify()", () => {
    ...
    it("Should return true if the signature is valid and ringSize = 1 - secp256k1", () => {
        const signature = src_1.RingSignature.sign([data.signerPubKey_secp256k1], data.signerPrivKey, data.message, secp256k1);
        ...
        expect((0, src_1.verifySchnorrSignature)(signature.messageDigest, data.signerPubKey_secp256k1, schnorrSig, secp256k1, undefined, true)).toBeTruthy();
    });
    it("Should return true if the signature is valid and ringSize = 1 - ed25519", () => {
        const signature = src_1.RingSignature.sign([data.signerPubKey_ed25519], data.signerPrivKey, data.message, ed25519);
        ...
        expect((0, src_1.verifySchnorrSignature)(signature.messageDigest, data.signerPubKey_ed25519, schnorrSig, ed25519, undefined, true)).toBeTruthy();
    });
