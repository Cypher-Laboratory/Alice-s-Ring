...
const message = (0, utils_2.uint8ArrayToHex)((0, sha3_1.keccak_256)("test"));
// console.log("alpha: ", alpha);
// seed the loop
const c3 = BigInt("0x" + (0, utils_2.uint8ArrayToHex)((0, sha3_1.keccak_256)(ring + message + G.mult(alpha).toString())));
console.log("c3: \n", G.mult(alpha), "\n");
// Iterate:
const c1 = BigInt("0x" +
    (0, utils_2.uint8ArrayToHex)((0, sha3_1.keccak_256)(ring + message + G.mult(r3).add(K3.mult(c3)).toString())));
const c2 = BigInt("0x" +
    (0, utils_2.uint8ArrayToHex)((0, sha3_1.keccak_256)(ring + message + G.mult(r1).add(K1.mult(c1)).toString())));
// signer response
...
const c3p = BigInt("0x" +
    (0, utils_2.uint8ArrayToHex)((0, sha3_1.keccak_256)(ring + message + G.mult(r2).add(K2.mult(c2p)).toString())));
// c3 should be equal to c3p
console.log("c3 === c3p: ", c3 === c3p);
const c1p = BigInt("0x" +
    (0, utils_2.uint8ArrayToHex)((0, sha3_1.keccak_256)(ring + message + G.mult(r3).add(K3.mult(c3p)).toString())));
console.log("c1: ", c1);
console.log("c2: ", c2);
console.log("c3: ", c3);
console.log("\n");
