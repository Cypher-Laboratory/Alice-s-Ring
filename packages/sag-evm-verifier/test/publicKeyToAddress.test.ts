...
describe("Public key to Ethereum address", function () {
  ...
  it("Verify a ring signature from the @cypher-laboratory/alicesring-sag package", async function () {
    ...
    expect(
      await SagVerifier.publicKeyToAddress(pubKey[0], pubKey[1]),
    ).to.equal("0xC355a41c7a9d3FC3Ed850c9B7755e7E404204524");
  });
