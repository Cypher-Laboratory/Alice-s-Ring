...
const ed = __importStar(require("../../../ring-sig-utils/src/utils/noble-libraries/noble-ED25519"));
const sha512_1 = require("@noble/hashes/sha512");
ed.etc.sha512Sync = (...m) => (0, sha512_1.sha512)(ed.etc.concatBytes(...m));
exports.privateKey = [
    // len = 10
    BigInt("0x" +
        (0, ring_sig_utils_1.hash)([
...
exports.signerPubKey_secp256k1 = (0, ring_sig_utils_1.derivePubKey)(exports.signerPrivKey, curves_1.SECP256K1);
exports.signerPubKey_ed25519 = (0, ring_sig_utils_1.derivePubKey)(exports.signerPrivKey, curves_1.ED25519);
/* --------------------------------------- */
...
exports.valid_string_point_ed25519 = new ring_sig_utils_1.Point(curves_1.ED25519, exports.valid_coordinates_ed25519).toString();
exports.valid_string_point_secp256k1 = new ring_sig_utils_1.Point(curves_1.SECP256K1, exports.valid_coordinates_secp256k1).toString();
...
exports.invalid_string_point_ed25519 = exports.valid_string_point_ed25519.slice(0, exports.valid_coordinates_ed25519.length - 3) +
    exports.valid_string_point_ed25519.slice(exports.valid_coordinates_ed25519.length - 2);
// invalid points
exports.idPoint_secp256k1 = new ring_sig_utils_1.Point(curves_1.SECP256K1, [0n, 0n], false);
exports.idPointX_secp256k1 = new ring_sig_utils_1.Point(curves_1.SECP256K1, [0n, 1n], false);
exports.idPointY_secp256k1 = new ring_sig_utils_1.Point(curves_1.SECP256K1, [1n, 0n], false);
exports.idPoint_ed25519 = new ring_sig_utils_1.Point(curves_1.ED25519, [0n, 0n], false);
exports.idPointX_ed25519 = new ring_sig_utils_1.Point(curves_1.ED25519, [0n, 1n], false);
exports.idPointY_ed25519 = new ring_sig_utils_1.Point(curves_1.ED25519, [1n, 0n], false);
