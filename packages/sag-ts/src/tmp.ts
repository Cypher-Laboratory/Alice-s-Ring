import { Curve, CurveName, keccak_256 } from "@cypher-laboratory/ring-sig-utils";
import { RingSignature } from "./ringSignature";
import * as data from "../test/data";
import { Point, hash, derivePubKey } from "@cypher-laboratory/ring-sig-utils";
import * as ed from "../../ring-sig-utils/src/utils/noble-libraries/noble-ED25519";
...
// load sig from json:
// const signature_json = require("../test/data/jsonSignatures.json").valid;


// compute message digest from signature.message

// const ring_sig = new RingSignature(
//   signature_json.message as string,
//   signature_json.ring.map((p: any) => Point.deserialize(p)),
//   BigInt("0x" + signature_json.c),
//   signature_json.responses.map((r: any) => BigInt("0x" + r)),
//   secp256k1,
//   {
//     evmCompatibility: true,
//   }
